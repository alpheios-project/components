...
describe('latin-ferre.test.js', () => {
  ...
  let targetWord = 'ferre'

  beforeAll(async () => {
    testHomonym = await maAdapter.getHomonym(Constants.LANG_LATIN, targetWord)
  ...
  let checkParts = [
    { part: 'verb', view: 'verbVoiceConjugationMood' },
    { part: 'verb', view: 'verbVoiceMoodConjugation' },
    { part: 'verb', view: 'verbConjugationVoiceMood' },
    { part: 'verb', view: 'verbConjugationMoodVoice' },
    { part: 'verb', view: 'verbMoodVoiceConjugation' },
    { part: 'verb', view: 'verbMoodConjugationVoice' },
    { part: 'verb', view: 'verbInfinitive' },
    { part: 'verb', view: 'verbImperative' },
    { part: 'verb', view: 'verbConjugationIrregularVoice' }
  ]
